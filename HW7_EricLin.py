...
def litCricFriend(wordList, text):
    ...
    for words in wList:
        newWordList.append(words.strip(string.punctuation))
...
print("Frequency of Bells (a/an)", litCricFriend(['a','an'], theBells))
print("Frequency of cantoXII (a/an)", litCricFriend(['a','an'], cantoXII))
print("Frequency of Bells (the)", litCricFriend(['the'], theBells))
print("Frequency of cantoXII (the)", litCricFriend(['the'], cantoXII))
...
'''
According to the results, yes. The results show that Poe and Neruda use 'a' and
'an' differently because the frequencies of 'a' and 'an' between the two poems
are different by one order of magnitude. The same is true for the frequencies of 'the' between the two
poems, thus Poe and Neruda use 'the' differently as well.
'''
